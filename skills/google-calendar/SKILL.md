...
description: Google Calendar 일정 조회, 검색, 등록. "오늘 일정", "이번 주 일정", "일정 검색", "미팅 잡아줘" 등을 언급하면 자동 실행. Daily Note 작성, Weekly Review, 스케줄 확인에 사용.
...
**실행:**
```bash
cd skills/google-calendar/scripts && python3 add_event.py "내일 오후 3시 회의"
```
...
✅ 일정이 등록되었습니다!
   제목: 회의
   시작: 2025-10-31 15:00
   링크: https://calendar.google.com/calendar/...
```
...
| "일정 추가" | add_event.py | `python3 add_event.py "자연어"` |
